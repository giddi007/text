          ...
          <div className=''>
            <div className='mt-17'>
              <div className='md:flex md:items-center md:justify-start'>
                <div className='flex items-center justify-center flex-col mb-10 md:w-110 xl:w-140'>
                  <h3 className='font-bold md:text-start md:text-3xl xl:mb-1'>
                    Who we are
                  </h3>
                  <h1 className='font-bold text-4xl md:text-start md:text-5xl xl:mb-5'>
                    We provide best digital services
                  </h1>
                  <p className='font-light md:text-start md:text-2xl'>
            ...
            <div className='block'>
              <div className='relative md:bottom-90'>
                <div>
                  <img src={img1} alt="" className='absolute top-1 right-50 md:top-1 md:right-75 md:w-28'/>
                  <img src={img2} alt="" className='absolute top-60 right-2 md:top-80 md:right-2 md:w-28'/>
                </div>
                <div>
                  <img src={img4} alt=""  className=' w-50 absolute right-0 rounded-3xl md:w-70 md:'/>
                  <img src={img3} alt=""  className=' w-50 absolute top-17 right-20 rounded-3xl md:w-70 md:top-23 md:right-30 '/>
                </div>
              </div>
            </div>
          </div>
